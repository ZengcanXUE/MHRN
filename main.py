...
def main():
    ...
    parser.add_argument('--model_name', type=str, default="MHRN", help='MHRN')
    ...
    parser.add_argument('--get_complex_results', type=bool, default=True, help='get complex results or not')
    parser.add_argument('--num_to_eval', type=int, default=5, help='number to evaluate')

    # learning parameters
    parser.add_argument('--learning_rate', type=float, default=5e-4, help='learning rate')
    parser.add_argument('--batch_size', type=int, default=128, help='batch size')
    parser.add_argument('--num_iterations', type=int, default=2000, help='iterations number')
    parser.add_argument('--optimizer_method', type=str, default="Adam", help='optimizer method')
    parser.add_argument('--decay_rate', type=float, default=0.999, help='decay rate')
    parser.add_argument('--label_smoothing', type=float, default=0.1, help='label smoothing')

    # convolution parameters
    # if ent_vec_dim and rel_vec_dim are 400, set: groups=2 * entity.size(0) in model.py
    ...
    parser.add_argument('--input_dropout', type=float, default=0.5, help='input dropout')
    parser.add_argument('--feature_map_dropout', type=float, default=0.3, help='feature map dropout')
    parser.add_argument('--hidden_dropout', type=float, default=0.6, help='hidden dropout')
